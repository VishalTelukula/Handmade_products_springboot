...
<nav class="navbar navbar-expand-lg navbar-light bg-light" >
    <div class="container-fluid">
        ...
        <h4>Welcome ${ username } </h4>
            <ul class="navbar-nav mr-autoz"></ul>
            <ul class="navbar-nav">
              ...
              <div class="container text-center">
                <div class="row">
                  <div class="col-sm-6 image">
                    <div class="item">
                      <h1>Products</h1>
                      <img class="img-fluid" src="https://m.media-amazon.com/images/I/718LBBFkhML._UL1500_.jpg" jsaction="load:XAeZkd;" jsname="HiaYvf" class="n3VNCb KAlRDb" alt="Silk Thread Handmade Bangles-Blue/Orange 10pcs for 2 hands (size 2.4) By  Amirtham" data-noaft="1" style="width: 351px; height: 351px; margin: 0px;" alt="">
                    </div><!--enditem-->
                  </div><!--endcol-->
                  <div class="col-sm-6">
                    <div class="details">
                      <h2 class="cr3"> Jwellary</h2>
                      <p class="cr4"> Bangles<br> handmade threadBangles</p>
                      <p class="cr1">100Rs</s></p>
                  <a href="/user/products">Buy Now</a>
                </div><!--enddetails-->
              </div><!--endcol-->
            </div><!--endrow-->
          </div><!--endcontainer-->
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Products</h1>
                  <img class="img-fluid" src="https://media.istockphoto.com/photos/lots-of-handmade-clay-pots-picture-id511647825" jsaction="load:XAeZkd;" jsname="HiaYvf" class="n3VNCb KAlRDb" alt="Lots Of Handmade Clay Pots Stock Photo - Download Image Now - Art And  Craft, Brown, Colors" data-noaft="1" style="width: 351px; height: 233.771px; margin: 0px;" alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <!--endtop-->
                <div class="details">
                  <h2 class="cr3">Hand Made Pots</h2>
                  <p class="cr4">POTS<br>handmade and longlasting</p>
                  <p class="cr1">150Rs</s></p>
              <a href="/user/products" >Buy Now</a>
            </div><!--enddetails-->
          </div><!--endcol-->
        </div><!--endrow-->
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-sm-6 image">
            <div class="item">
              <h1>Products</h1>
              <img class="img-fluid" src="https://i.pinimg.com/564x/74/04/2d/74042d64c823842caaff1c67b9546a79.jpg" jsaction="load:XAeZkd;" jsname="HiaYvf" class="n3VNCb KAlRDb" alt="Lots Of Handmade Clay Pots Stock Photo - Download Image Now - Art And  Craft, Brown, Colors" data-noaft="1" style="width: 351px; height: 233.771px; margin: 0px;" alt="">
            </div><!--enditem-->
          </div><!--endcol-->
          <div class="col-sm-6">
            <div class="details">
              <h2 class="cr3">Wall Hangings</h2>
              <p class="cr4">handcrafts<br>crafts</p>
              <p class="cr1">150Rs</s></p>
          <a href="/user/products" >Buy Now</a>
        </div><!--enddetails-->
      </div><!--endcol-->
...
<div class="row">
   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
                            <div class="card">
                                <a class="img-card">
                                    <img src="https://cdn.shopify.com/s/files/1/0070/7032/files/selling-handmade-goods.png?format=jpg&quality=90&v=1528140509" />
...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
                            <div class="card">
                                <a class="img-card">
                                    <img src="https://cdn.searchenginejournal.com/wp-content/uploads/2020/08/contact-us-pages-sej-5f63d4f927b04-1520x800.png" />
	...
	<style>
        ...
        * {
        ...
        .container-fostrap {
            ...
            background-image: linear-gradient(315deg, #e2adca 0%, #f87d83 74%);
            padding: 1em;
            text-align: center;
